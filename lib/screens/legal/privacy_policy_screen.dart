...
class PrivacyPolicyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final privacyUrl = context.watch<PlatformConfigProvider>().config.privacyPolicyUrl;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildBulletPoint(
              context,
              'Wallet address for Roochip transactions',
            ),
            ...
            _buildBulletPoint(
              context,
              'Process Roochip rewards and transactions',
            ),
            _buildBulletPoint(
              context,
            ...
            _buildSectionTitle(context, '4. Blockchain & Roochip'),
            _buildParagraph(
              context,
              'Roochip transactions are recorded on the Ethereum blockchain. Please note:',
            ),
            _buildBulletPoint(
              context,
